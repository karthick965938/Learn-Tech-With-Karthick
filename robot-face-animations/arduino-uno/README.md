# 🚀 Arduino Uno - Robot Face Animations

This section contains the code and wiring details for the **Arduino Uno**.

## 🔌 Wiring Diagram

| OLED Pin | Arduino Uno Pin | Note |
| :--- | :--- | :--- |
| **VCC** | **3.3V / 5V** | Power |
| **GND** | **GND** | Ground |
...
![Arduino Uno Output](arduino-uno-result.png)

## 📁 How to Use
1. Open [`arduino_uno_oled_eyes.ino`](arduino_uno_oled_eyes.ino) in the Arduino IDE.
2. Select **Arduino Uno** from the boards menu.
